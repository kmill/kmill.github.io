...
\cventry{2021--present}{Postdoc}{University of California}{Santa Cruz, CA}{}{}

\cventry{2022--2023}{Postdoc}{Universit\'{e} Paris-Saclay (FMJH)}{Orsay, France}{}{}
...
I look for, specify, and implement improvements to the experience of using Lean, the functional programming language and interactive theorem prover.
}
...
\cvitem{2023}{\emph{The homological arrow polynomial for virtual links}, Journal of Knot Theory and Its Ramifications
(2023), \href{https://arxiv.org/abs/2207.02427}{arXiv:2207.02427}.}

\cvitem{2021}{Anderson, Baker, Gao, Kegel, Le, Miller, Onaran, Sangston, Tripp, Wood, and Wright, \emph{L-space knots with tunnel number $>1$ by experiment}, Experimental Mathematics (2021), \href{https://arxiv.org/abs/1909.00790}{arXiv:1909.00790}.}
...
\cvitem{2018}{McPhail-Snyder and Miller, \emph{Planar diagrams for local invariants of graphs in surfaces}, Journal of Knot Theory and Its Ramifications
  (2020), \href{https://arxiv.org/abs/1805.00575}{arXiv:1805.00575}.}

\subsection{Preprints}

\cvitem{2020}{\emph{All the ways I know how to define the Alexander Polynomial} \href{https://math.berkeley.edu/~kmill/notes/alexander_poly_2020_11_14.pdf}{(link to pdf)}}
...
\cvitem{}{\emph{Indexed stream fusion}, with Scott Kovach and Fredrik Kjolstad}

\cvitem{}{\emph{Doing graph theory in Lean}}

\cvitem{}{\emph{The two-variable virtual Yamada polynomial}.}

\cvitem{}{\emph{Surface graph invariants as extended 2D TQFTs}.}
...
\section{Service}
\cvitem{Sep. 2023}{Teaching assistant for \emph{Formal Mathematics and Computer-Assisted Proving} at Hausdorff School, University of Bonn}
\cvitem{June 2023}{Speaker and teaching assistant for \emph{Formalization of Mathematics} summer school at SLMath (formerly MSRI) in Berkeley, CA}
\cvitem{2021--present}{Maintainer and contributor for \href{https://github.com/leanprover-community/mathlib}{\texttt{mathlib}}, the Lean mathematics library.}
\cvitem{2021--present}{Maintainer for \href{https://github.com/UCBMath/pyquiz}{\texttt{pyquiz}}, a tool for constructing Canvas math quizzes with randomness.}
%\cvitem{2020--present}{Contributor to \href{https://github.com/leanprover-community/mathlib}{\texttt{mathlib}}.}
\cvitem{}{Reviewed for Annales de l'Institut Henri Poincar\'{e} D: Combinatorics, Physics and their Interactions.}
\cventry{Fa2019}{Student $3$-Manifold Seminar (organizer)}{University of California}{Berkeley, CA}{}{}
\cvitem{Su2019}{\textbf{KnotFolio}, an online program for recognizing and identifying drawings of knots and links. \href{https://knotfol.io/}{https://knotfol.io/}}
...
\cvitem{Wi2024}{Math 11B Calculus with Applications (172 students)}
