...
I look for, specify, and implement improvements to improve the experience in using Lean, the functional programming language and interactive theorem prover.
}
...
Implemented analyses to run efficiently on hundreds of terabytes of data.
...
\cvitem{}{\emph{The design of the mathlib graph theory library}}
...
\cvitem{Su2019}{\textbf{KnotFolio}, an online program for recognizing and identifying drawings of knots and links. \href{https://knotfol.io/}{https://kmill.github.io/knotfolio}}
...
% %\cventry{Su2017--present}{Graduate Student Researcher}{University of California}{Berkeley, CA}{}{}
...
% Worked on natural human-computer interactions for mathematics. With Randall Davis.
% }
% \cventry{Sp2009}{UROP}{MIT Humans and Automation Laboratory}{Cambridge, MA}{}{
% Developed a simulation to study efficient team structures.
% }
